...
*/
  while (1) {
    ...
    if (!strcmp(command,"white")) wtm=1;
    else if (!strcmp(command,"black")) wtm=0;
    if (!strcmp(command,"#"))
      for (i=0;i<64;i++) PieceOnSquare(i)=0;
    else if (!strcmp(command,"c")) wtm=ChangeSide(wtm);
    else if (!strcmp(command,"end") || (!strcmp(command,"."))) break;
    else if (!strcmp(command,"d")) DisplayChessBoard(stdout,search);
    else {
