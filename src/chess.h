...
#  endif
  ...
  void           LearnBookUpdate(int,int,int);
  int            LearnFunction(int,int,int,int);
  void           LearnImport(char*);
  void           LearnImportBook(char*);
  void           LearnImportPosition(char*);
